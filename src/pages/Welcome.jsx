...
export default function Welcome() {
  return (
    <div className=' w-full h-screen p-10 bg-[#0b131e] grid grid-cols-2 place-items-center overflow-hidden   '>
      
      <img src="/wether.webp" alt="" className=' w-full h-full object-cover overflow-hidden rounded-[10px]  ' />
      ...
      <div className="flex items-center justify-center  flex-col gap-5 text-white font-ubuntu ">
        ...
        <h2 className="font-bold text-3xl">Welcome to Weather App</h2>
